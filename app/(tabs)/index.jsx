...
const TabOneScreen = () => {
  return (
    ...
    {/* places */}
    <View className="flex-row  items-center mb-5 overflow-y-auto gap-2" style={{backgroundColor:'white'}}>
    ...
    {/* Cards Section */}
      ...
      <InfoCard isTemperature={false} deviceName="Home Light" iconName="bulb" location="Bedroom" />

      <InfoCard isTemperature={false} deviceName="Night Light" iconName="bulb" location="Bedroom" />
...
const styles = StyleSheet.create({
  safeArea: {
    ...
    backgroundColor: "white", // Background color for safe area
  },
  screenContainer: {
    flex: 1, // Ensures View takes full remaining height
    backgroundColor: "white", // Matches the safe area background
    paddingTop:10,
